...
```
python cifar_main.py --method ours --test_batch_size 32 --lr 1e-2 --prompt_lr 1e-5 --num_classes 10 --device 0
python cifar_main.py --method ours --test_batch_size 32 --lr 1e-2 --prompt_lr 1e-5 --num_classes 100 --device 0
...
**Usage in ImageNet-C**:
```
python main.py --method ours --test_batch_size 64 --lr 1e-2 --prompt_lr 5e-4 --num_classes 1000 --device 0  --data_corruption XX
...
```
python main.py --method ours --test_batch_size 1 --lr 1e-5 --prompt_lr 1e-5 --num_classes 1000 --device 0  --data_corruption XX
